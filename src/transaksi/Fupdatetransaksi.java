 ...
 * @author Aldy Senda
 */
public class Fupdatetransaksi extends javax.swing.JDialog {
    ...
    public Fupdatetransaksi(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void setForm(transaksi t)
    {
        txtNoNota.setText(t.getNoNota());
        txtIdHirepoint.setText(t.getIdHirepoint());
        txtIdCustomer.setText(t.getIdCustomer());
        txtIdMobil.setText(t.getIdMobil());
        txtTotalBayar.setText(String.valueOf(t.getTotalBayar()));
    }
            ...
            if (r.next()) {
                ...
                if (ID.length()==1) 
                    {Zero = "0";}
                     ...
                     {Zero = "";}
                txtNoNota.setText("N" + Zero + ID);
                } else {
                txtNoNota.setText("N01");
                }
                r.close();
                s.close();
        } catch (Exception e){
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        db.update_transaksi(new transaksi (txtNoNota.getText(), txtIdHirepoint.getText(), txtIdCustomer.getText(), 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fupdatetransaksi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Fupdatetransaksi dialog = new Fupdatetransaksi(new javax.swing.JFrame(), true);
